...
import info.efficacious.esmartsdemo.adapters.NoticeBoardAdapter;
import info.efficacious.esmartsdemo.adapters.StudentListAdapter;
...
import info.efficacious.esmartsdemo.entity.Holiday;
    ...
    public DisposableObserver<DashboardDetailsPojo> getObserverStudentCount() {
        return new DisposableObserver<DashboardDetailsPojo>() {
            ...
            public void onError(@NonNull Throwable e) {
                Toast.makeText(getActivity(), "Student : Response Taking Time,Seems Network issue!", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
...
//            Toast.makeText(getActivity(), "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
    ...
    public DisposableObserver<DashboardDetailsPojo> getObserverStaffCount() {
        return new DisposableObserver<DashboardDetailsPojo>() {
            ...
            @Override
            public void onError(@NonNull Throwable e) {
                Toast.makeText(getActivity(), "Staff : Response Taking Time,Seems Network issue!", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
...
//            Toast.makeText(getActivity(), "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
    ...
    public DisposableObserver<DashboardDetailsPojo> getObserver() {
        return new DisposableObserver<DashboardDetailsPojo>() {
            ...
            @Override
            public void onError(@NonNull Throwable e) {
                Toast.makeText(getActivity(), "Student List : Response Taking Time,Seems Network issue!", Toast.LENGTH_SHORT).show();
            }
    ...
    public DisposableObserver<DashboardDetailsPojo> getObserverNotice() {
        return new DisposableObserver<DashboardDetailsPojo>() {
            ...
            @Override
            public void onError(@NonNull Throwable e) {
                Toast.makeText(getActivity(), "Notice board : Response Taking Time,Seems Network issue!", Toast.LENGTH_SHORT).show();
            }
        ...
        try {
            ...
            call.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Observer<DashboardDetailsPojo>() {
                ...
                public void onError(Throwable t) {
                    ...
                    Toast.makeText(getActivity(), "Holiday : Response Taking Time,Seems Network issue!", Toast.LENGTH_SHORT).show();
